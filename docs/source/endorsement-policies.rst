...
in terms of the MSP identifiers of organizations, see `KeyEndorsementPolicy <https://godoc.org/github.com/littlegirlpppp/fabric-chaincode-go/pkg/statebased#KeyEndorsementPolicy>`_:
